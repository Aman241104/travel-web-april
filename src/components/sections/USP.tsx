  ...
  return (
    ...
    >
      ...
      <div className="container-custom relative z-10">
        ...
        {/* Editorial Header */}
        <div className="usp-header flex flex-col items-center text-center mb-10 lg:mb-20 space-y-6 lg:space-y-8">
          ...
          <h2 className="text-[34px] md:text-[52px] lg:text-[68px] xl:text-[80px] font-sans font-black text-gray-950 leading-[0.95] lg:leading-[1] tracking-tightest uppercase max-w-5xl">
            ...
            <span className="block usp-headline-line text-primary italic font-serif font-light lowercase normal-case py-1">unforgettable</span>
        ...
        <div className="relative">
          ...
          <div className="usp-steps-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-12 mb-16 lg:mb-32">
            {steps.map((step, i) => (
              <div
                key={i}
                className="usp-step-card relative p-7 lg:p-12 rounded-[32px] lg:rounded-[56px] bg-gray-50/50 backdrop-blur-xl border border-gray-100 shadow-sm hover:bg-white hover:shadow-[0_40px_100px_rgba(56,142,60,0.08)] transition-all duration-1000 group text-center flex flex-col items-center overflow-hidden active:scale-[0.98]"
              >
                ...
                <div className="space-y-3 lg:space-y-4 relative z-10">
                  <h3 className="text-xl lg:text-3xl font-sans font-black text-gray-950 tracking-tightest group-hover:text-primary transition-colors duration-700 uppercase leading-none">
                    {step.title}
                  </h3>
                  
                  <div className="relative min-h-[80px] lg:min-h-[120px] w-full flex items-center justify-center">
                    {/* Short Description */}
                    <p className="text-gray-950 font-black text-[13px] lg:text-base leading-tight transition-all duration-700 group-hover:-translate-y-20 group-hover:opacity-0 uppercase tracking-[0.15em] lg:tracking-widest opacity-50">
                      {step.shortDesc}
                    </p>
                    
                    {/* Detailed Content Reveal */}
                    <p className="absolute inset-0 w-full text-gray-500 text-[11px] lg:text-lg leading-relaxed opacity-0 translate-y-8 lg:translate-y-12 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-1000 ease-[0.16,1,0.3,1] flex items-center justify-center text-center font-medium tracking-tight">
                      {step.desc}
                    </p>
                  </div>
                </div>
        ...
        <div className="flex flex-col items-center space-y-10 lg:space-y-12">
          <div className="flex items-center gap-4 lg:gap-6 opacity-30">
            <Globe className="w-4 h-4 lg:w-5 lg:h-5" />
            <div className="w-16 lg:w-24 h-[1px] bg-gray-950" />
            <Sparkles className="w-4 h-4 lg:w-5 lg:h-5" />
            <div className="w-16 lg:w-24 h-[1px] bg-gray-950" />
            <Compass className="w-4 h-4 lg:w-5 lg:h-5" />
          </div>

          <div className="relative p-1.5 lg:p-2 bg-gray-50 rounded-[28px] lg:rounded-[32px] border border-gray-100 shadow-inner">
            <MagneticButton className="px-10 py-5 lg:px-20 lg:py-8 bg-[#050807] hover:bg-primary text-white font-black rounded-2xl lg:rounded-[32px] flex items-center gap-4 lg:gap-6 transition-all shadow-3xl group text-[11px] lg:text-sm uppercase tracking-[0.3em] lg:tracking-[0.4em] relative overflow-hidden active:scale-95">
              ...
              <ArrowRight className="w-4 h-4 lg:w-7 lg:h-7 group-hover:translate-x-3 lg:group-hover:translate-x-4 transition-transform duration-700 relative z-10" />
            </MagneticButton>
          </div>
          ...
          <div className="flex items-center gap-4 text-gray-400">
             ...
             <p className="text-[9px] lg:text-[11px] font-bold uppercase tracking-[0.2em] lg:tracking-[0.3em]">
