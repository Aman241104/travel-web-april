...
export default function StatsBar() {
  return (
    <section className="relative z-30 py-28 bg-brand-dark overflow-hidden border-y border-white/5">
      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-20 gap-x-12 items-center justify-items-center">
          {stats.map((stat, i) => (
            <motion.div
              key={i}
            ...
            >
              <div className="relative mb-6">
                <div className="text-5xl lg:text-7xl font-serif font-bold text-accent-gold tracking-tighter drop-shadow-[0_10px_30px_rgba(197,160,89,0.2)] group-hover:scale-105 transition-transform duration-700">
                  {stat.value}
                </div>
              ...
              <div className="flex flex-col items-center gap-1.5">
                <div className="text-[12px] font-black uppercase tracking-[0.4em] text-white group-hover:text-primary transition-colors duration-500">
                  {stat.label}
                </div>
                <div className="text-[10px] text-white/30 uppercase tracking-[0.3em] font-bold group-hover:text-white/50 transition-colors duration-500">
                  {stat.sub}
                </div>
              </div>
